...
const talent2_3 = {
  2: [
    {material: Books.TEACHINGS_OF_PROSPERITY, count: 3, sorting_index: 1},
    {material: Materials.FIRM_ARROWHEAD, count: 6, sorting_index: 8},
    {material: MORA, count: 12500}
  ],
  3: [
    {material: Books.GUIDE_TO_DILIGENCE, count: 2, sorting_index: 4},
    {material: Materials.SHARP_ARROWHEAD, count: 3, sorting_index: 8},
    {material: MORA, count: 17500}
  ],
  4: [
    {material: Books.GUIDE_TO_GOLD, count: 4, sorting_index: 2},
    {material: Materials.SHARP_ARROWHEAD, count: 4, sorting_index: 8},
    {material: MORA, count: 25000}
  ],
  5: [
    {material: Books.GUIDE_TO_PROSPERITY, count: 6, sorting_index: 3},
    {material: Materials.SHARP_ARROWHEAD, count: 6, sorting_index: 8},
    {material: MORA, count: 30000}
  ],
  6: [
    {material: Books.GUIDE_TO_DILIGENCE, count: 9, sorting_index: 4},
    {material: Materials.SHARP_ARROWHEAD, count: 9, sorting_index: 8},
    {material: MORA, count: 37500}
  ],
  7: [
    {material: Books.PHILOSOPHIES_OF_GOLD, count: 4, sorting_index: 7},
    {material: Materials.WEATHERED_ARROWHEAD, count: 4, sorting_index: 8},
    {material: BossSkillMaterial.TAIL_OF_BOREAS, count: 1, sorting_index: 9},
    {material: MORA, count: 120000}
  ],
  8: [
    {material: Books.PHILOSOPHIES_OF_PROSPERITY, count: 6, sorting_index: 5},
    {material: Materials.WEATHERED_ARROWHEAD, count: 6, sorting_index: 8},
    {material: BossSkillMaterial.TAIL_OF_BOREAS, count: 1, sorting_index: 9},
    {material: MORA, count: 260000}
  ],
  9: [
    {material: Books.PHILOSOPHIES_OF_DILIGENCE, count: 12, sorting_index: 6},
    {material: Materials.WEATHERED_ARROWHEAD, count: 9, sorting_index: 8},
    {material: BossSkillMaterial.TAIL_OF_BOREAS, count: 2, sorting_index: 9},
    {material: MORA, count: 450000}
  ],
  10: [
    {material: Books.PHILOSOPHIES_OF_GOLD, count: 16, sorting_index: 7},
    {material: Materials.WEATHERED_ARROWHEAD, count: 12, sorting_index: 8},
    {material: BossSkillMaterial.TAIL_OF_BOREAS, count: 2, sorting_index: 9},
    {material: CROWN_OF_INSIGHT, count: 1},
    {material: MORA, count: 700000}
  ]
